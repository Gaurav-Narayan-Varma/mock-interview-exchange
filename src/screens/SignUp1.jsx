...
export const SignUp1 = ({}) => {
  ...
  return (
    <SignUp>
      ...
      <Line src={`https://file.rendit.io/n/0H0KdCXDpPk40mUEcRXs.png`} />
      <Line1 src={`https://file.rendit.io/n/LYC7wg0ZmylqddCWLopX.png`} />
      <BG>
        <Text6>Name</Text6>
      </BG>
      <BG1>
        ...
        <Background>
          ...
          <Group4>
            <WhiteSquare>
              <Symbol> </Symbol>
              <Shift
                src={`https://file.rendit.io/n/ePmEU3mvOGRdSHgwI4zk.svg`}
              />
            </WhiteSquare>
            <WhiteRectangle6>
              <Symbol7>Z</Symbol7>
          ...
          <Group6>
            <Emoji src={`https://file.rendit.io/n/jJGmbQyMJ91ccgCYSO5d.svg`} />
            <Dictation
              src={`https://file.rendit.io/n/LIk2E4wQmI1zg9UeohJc.svg`}
            />
          </Group6>
          <HomeIndicator />
        </Background>
...
const BG = styled.div`
  ...
  background-image: url("https://file.rendit.io/n/e7wGWRDU23ZRJtI0tDq8.svg");
`;
...
const Element4 = styled.div`
  ...
  box-sizing: border-box;
  background-size: cover;
  background-image: url("https://file.rendit.io/n/KHPvKodUznHx5e7xMESI.svg");
`;
...
const DeleteButton = styled.button`
  ...
  background-image: url("https://file.rendit.io/n/y4BX5DMyebyurBFQx3bc.svg");
  cursor: pointer;
  &: hover {
    box-shadow: inset 0 0 100px 100px rgba(255, 255, 255, 0.3);
  } ;
